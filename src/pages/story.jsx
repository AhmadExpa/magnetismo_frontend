      ...
      >
        <section>
          <div className="relative  mb-12 w-full md:h-[700px] h-[300px] flex justify-center items-center">
            ...
            >
              <source
                src={VITE_STORY_HERO_SECTION_VIDEO_URL}
                type="video/mp4"
              />
        ...
        <section>
          <section className="flex flex-col mb-12 justify-center items-center">
            ...
            <p className="text-gray-800 md:px-0 px-4 text-center">
              We are a global leader in the design, manufacture, and
              distribution of ophthalmic lenses, frames, and sunglasses.
            </p>
          </section>
          ...
          <nav className="flex justify-center space-x-4 md:space-x-8 mx-4 md:mx-0 text-gray-500 text-sm md:text-md border-b pb-3">
            ...
            <RouterLink
              to="/how-it-works/story#story-section"
              id="story-section"
              className="text-[#273771] border-b-2 border-[#273771] first-letter:uppercase md:uppercase scroll-mt-20"
            >
              story
            </RouterLink>
            <RouterLink
        ...
        <section className="bg-gray-100  py-5 px-4 md:px-20 text-gray-800">
...
/>
          ...
          <div className="flex justify-between md:flex-row flex-col">
            <div className="text-md text-gray-700 leading-relaxed">
              <p className="lg:mb-6">
                As the age-old adage goes: "Necessity is the mother of
                invention."
              </p>
              <p className="lg:mb-6">
                ...
                science as the second most excruciating ailment after child
                labour pain and sadly its exact cause and cure remains elusive.
              </p>
              <p className="lg:mb-6">
                ...
                either dilate or constrict due to strain and stress.
                Understanding this process led me to explore a unique approach
                in helping to alleviate migraine attacks. I was cognizant that
                blood contains iron (in the form of ferrous oxide) and that
                magnets have the ability to interact positively with iron.
              </p>
              <p className="mb-6 ">
            ...
            <div className="text-md text-gray-700 ml-0 md:ml-7 ">
              ...
              <p className="lg:mb-6">
                Rather than sell the idea to corporate giants for commercial
                gain, I want to ensure this innovation swiftly reaches those who
                need it most so that they can also experience the same natural
                headache relief without side effects.
              </p>
              <p className="lg:mb-6 ">
                With Magnetismo, our mission is simple: To empower individuals
                to thrive amid focused and pain-free lives. Whether you’re a
                gamer, designer, or remote worker dealing with eye strain from
                working at home, <br />
              ...
              <p className="font-semibold text-[#273771] mt-3 md:mt-0">
                Let us help you, relieve your eyes and energize your mind.{" "}
                <br />
